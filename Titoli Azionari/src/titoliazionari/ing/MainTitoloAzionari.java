...
public class MainTitoloAzionari {
	...
	private static File file=new File("E:\\peter.txt");
	...
	{
		if(FileServizio.esistenzafile(file))
			flag=0;
		else 
			flag =1;
		if(flag==1)
		...
		if(flag==0)
		{ FileServizio.trovareUnoNuovo(portaFoglio, titoli, elencoTitoli, lotto);
	...
	FileServizio.creareUnoNuovo(portaFoglio, titoli, elencoTitoli, lotto);
